...
$string['admindefaultvisualsintro'] = 'The following images will be used as defaults when the block is newly added to a course.';
...
$string['configdescription_help'] = 'A short description displayed in the block, below the user\'s level.';
