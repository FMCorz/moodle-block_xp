...
Feature: The levels page allows customising the levels
  ...
  Scenario: The points of the levels can be quickly edited
    ...
    And I press tab
    When I press "Apply"
    Then the field "xp-level-1-start" matches value "0"
    And the field "xp-level-1-length" matches value "10"
    And the field "xp-level-2-start" matches value "10"
    And the field "xp-level-2-length" matches value "10"
    And the field "xp-level-3-start" matches value "20"
    And the field "xp-level-3-length" matches value "10"
